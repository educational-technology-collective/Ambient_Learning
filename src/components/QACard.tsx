...
import { IonCard, IonCardContent, IonText, createGesture, IonItem, IonIcon } from "@ionic/react";
import "./QACard.css";
    ...
    <div className="card-wrapper" ref={ref}>
      ...
      >
        ...
        <IonCardContent class="card-content" style={style}>
          ...
          {/* //Front Negative */}
         <div className="front negative front-negative" style={{opacity: negativeOpacity}}>
          <IonItem className='action-container negative-container'>
            <IonText className="action-text negative-text">F O R G E T </IonText>
            <IonIcon icon={sadOutline} style={{color: '#D63230', fontSize: '2em'}}></IonIcon>
          </IonItem>
         </div>

        {/* Front Positive */}
         <div className="front positive front-positive" style={{opacity: positiveOpacity}}>
          <IonItem className='action-container positive-container'>
            <IonText className="action-text positive-text">K N O W</IonText>
            <IonIcon icon={happy} style={{color: '#256D1B', fontSize: '2em'}}></IonIcon>
          </IonItem>
         </div>
        ...
        {/* Front OneMore */}
         <div className="front onemore" style={{opacity: onemoreOpacity}}>
          <IonItem className='action-container onemore-container'>
            ...
            <IonIcon icon={card} style={{color: '#7BB2D9', fontSize: '2em'}}></IonIcon>
          </IonItem>
         </div>
        ...
        {/* Front Nomore */}
         <div className="front nomore" style={{opacity: nomoreOpacity}}>
          <IonItem className='action-container nomore-container'>
            ...
            <IonIcon icon={close} style={{color: '#E8871E', fontSize: '2em'}}></IonIcon>
          </IonItem>
         </div>
        ...
        {/* Back Negative */}
        <div className="back negative back-negative" style={{opacity: negativeOpacity}}>
          <IonItem className='action-container negative-container'>
            <IonText className="action-text negative-text">F O R G E T </IonText>
            <IonIcon icon={sadOutline} style={{color: '#D63230', fontSize: '2em'}}></IonIcon>
          </IonItem>
        ...
        {/* Back Positive */}
        <div className="back positive back-positive" style={{opacity: positiveOpacity}}>
          <IonItem className='action-container positive-container'>
            <IonText className="action-text positive-text">K N O W</IonText>
            <IonIcon icon={happy} style={{color: '#256D1B', fontSize: '2em'}}></IonIcon>
          </IonItem>
